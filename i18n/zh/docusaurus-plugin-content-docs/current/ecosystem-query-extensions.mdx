...
[`query-extensions`][gh] is an experimental companion library for Testing Library that mixes a higher-level API into the standard `@testing-library` core queries
