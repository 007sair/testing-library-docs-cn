...
> **Note**
> 
> If you want to combine setupTests with another setup you should check [`setup`](react-testing-library/setup.mdx)
...
To test our translated component we can create a custom `render` function using the `wrapper` option as explained in the [setup](react-testing-library/setup.mdx) page.  
