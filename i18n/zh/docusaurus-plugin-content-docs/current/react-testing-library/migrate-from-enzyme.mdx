...
In general, you should avoid mocking out components. However, if you need to, then try using [Jest's mocking feature](https://jestjs.io/docs/en/manual-mocks.html). For more information, see the [FAQ](react-testing-library/faq.mdx).
