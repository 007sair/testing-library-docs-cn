...
[`bs-jest-dom`][gh] is a companion library for [`bs-react-testing-library`](bs-react-testing-library/intro.mdx) that provides custom DOM element matchers for Jest in [ReasonML][re] via [BuckleScript][bucklescript].
