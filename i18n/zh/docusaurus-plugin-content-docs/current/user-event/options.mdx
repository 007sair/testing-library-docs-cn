...
[`type()`](api-utility.mdx#type) automatically releases any keys still pressed at the end of the call.  
...
[`click()`](api-utility.mdx#click) implies moving the cursor to the target element first.  
